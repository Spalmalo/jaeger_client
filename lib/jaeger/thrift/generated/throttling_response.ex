defmodule(Jaeger.Thrift.Generated.ThrottlingResponse) do
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(deserialize__service_configs(<<rest::binary>>, [list, remaining | stack])) do
      case(
        Elixir.Jaeger.Thrift.Generated.ServiceThrottlingConfig.BinaryProtocol.deserialize(rest)
      ) do
        {element, rest} ->
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.ThrottlingResponse{
        ...
        case(default_config) do
          nil ->
            raise(
              ...
              "Required field :default_config on Jaeger.Thrift.Generated.ThrottlingResponse must not be nil"
            )

          _ ->
            [
              <<12, 1::16-signed>>
              | Jaeger.Thrift.Generated.ThrottlingConfig.serialize(default_config)
            ]
        end,
        case(service_configs) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :service_configs on Jaeger.Thrift.Generated.ThrottlingResponse must not be nil"
            )

          _ ->
            [
              <<15, 2::16-signed, 12, length(service_configs)::32-signed>>
              | for(e <- service_configs) do
