defmodule(Jaeger.Thrift.Generated.BaggageRestrictionManager) do
  ...
  defmodule(GetBaggageRestrictionsResponse) do
    ...
    defmodule(BinaryProtocol) do
      ...
      defp(deserialize__success(<<rest::binary>>, [list, remaining | stack])) do
        case(Elixir.Jaeger.Thrift.Generated.BaggageRestriction.BinaryProtocol.deserialize(rest)) do
          {element, rest} ->
  ...
  defmodule(Binary.Framed.Client) do
    ...
    def(unquote(:get_baggage_restrictions)(client, service_name, rpc_opts \\ [])) do
      ...
      ClientImpl.call(client, "getBaggageRestrictions", serialized_args, GetBaggageRestrictionsResponse.BinaryProtocol, rpc_opts)
    end
    def(unquote(:get_baggage_restrictions!)(client, service_name, rpc_opts \\ [])) do
  ...
  defmodule(Binary.Framed.Server) do
    ...
    def(handle_thrift("getBaggageRestrictions", binary_data, handler_module)) do
      case(Elixir.Jaeger.Thrift.Generated.BaggageRestrictionManager.GetBaggageRestrictionsArgs.BinaryProtocol.deserialize(binary_data)) do
        {%Jaeger.Thrift.Generated.BaggageRestrictionManager.GetBaggageRestrictionsArgs{service_name: service_name}, ""} ->
          try do
            rsp = handler_module.get_baggage_restrictions(service_name)
            (
              response = %Jaeger.Thrift.Generated.BaggageRestrictionManager.GetBaggageRestrictionsResponse{success: rsp}
              {:reply, Elixir.Jaeger.Thrift.Generated.BaggageRestrictionManager.GetBaggageRestrictionsResponse.BinaryProtocol.serialize(response)}
            )
          catch
            kind, reason ->
