defmodule(Jaeger.Thrift.Generated.BaggageRestriction) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(serialize(%Jaeger.Thrift.Generated.BaggageRestriction{baggage_key: baggage_key, max_value_length: max_value_length})) do
      [case(baggage_key) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :baggage_key on Jaeger.Thrift.Generated.BaggageRestriction must not be nil")
        _ ->
          [<<11, 1::16-signed, byte_size(baggage_key)::32-signed>> | baggage_key]
      end, case(max_value_length) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :max_value_length on Jaeger.Thrift.Generated.BaggageRestriction must not be nil")
        _ ->
