defmodule(Jaeger.Thrift.Generated.RateLimitingSamplingStrategy) do
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.RateLimitingSamplingStrategy{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Jaeger.Thrift.Generated.RateLimitingSamplingStrategy{max_traces_per_second: max_traces_per_second})) do
      [case(max_traces_per_second) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :max_traces_per_second on Jaeger.Thrift.Generated.RateLimitingSamplingStrategy must not be nil")
        _ ->
