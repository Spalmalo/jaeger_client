defmodule(Jaeger.Thrift.Generated.ClientStats) do
  ...
  defstruct(
    full_queue_dropped_spans: nil,
    too_large_dropped_spans: nil,
    failed_to_emit_spans: nil
  )
  ...
  defmodule(BinaryProtocol) do
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.ClientStats{
        ...
        case(full_queue_dropped_spans) do
          nil ->
            raise(
              ...
              "Required field :full_queue_dropped_spans on Jaeger.Thrift.Generated.ClientStats must not be nil"
            )

          _ ->
            <<10, 1::16-signed, full_queue_dropped_spans::64-signed>>
        end,
        case(too_large_dropped_spans) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :too_large_dropped_spans on Jaeger.Thrift.Generated.ClientStats must not be nil"
            )

          _ ->
            <<10, 2::16-signed, too_large_dropped_spans::64-signed>>
        end,
        case(failed_to_emit_spans) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :failed_to_emit_spans on Jaeger.Thrift.Generated.ClientStats must not be nil"
            )
