defmodule(Jaeger.Thrift.Generated.Tag) do
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(
      deserialize(
        <<11, 7::16-signed, string_size::32-signed, value::binary-size(string_size),
          rest::binary>>,
        acc
      )
    ) do
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.Tag{
        key: key,
        v_type: v_type,
        v_str: v_str,
        v_double: v_double,
      ...
      [
        case(key) do
          nil ->
            raise(
              ...
              "Required field :key on Jaeger.Thrift.Generated.Tag must not be nil"
            )
        ...
        case(v_type) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :v_type on Jaeger.Thrift.Generated.Tag must not be nil"
            )
        ...
        case(v_bool) do
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :v_bool on Jaeger.Thrift.Generated.Tag must be true, false, or nil"
            )
        end,
        case(v_long) do
          nil ->
