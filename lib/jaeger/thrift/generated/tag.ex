defmodule(Jaeger.Thrift.Generated.Tag) do
  @moduledoc(false)
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Jaeger.Thrift.Generated.Tag{})
    end
    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.Tag{} = acc)) do
      {acc, rest}
    end
    ...
    defp(deserialize(<<4, 4::16-signed, 0::1, 2047::11, 0::52, rest::binary>>, acc)) do
      deserialize(rest, %{acc | v_double: :inf})
    end
    ...
    defp(deserialize(<<4, 4::16-signed, sign::1, 2047::11, frac::52, rest::binary>>, acc)) do
      deserialize(rest, %{acc | v_double: %Thrift.NaN{sign: sign, fraction: frac}})
    end
    ...
    def(serialize(%Jaeger.Thrift.Generated.Tag{key: key, v_type: v_type, v_str: v_str, v_double: v_double, v_bool: v_bool, v_long: v_long, v_binary: v_binary})) do
      [case(key) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :key on Jaeger.Thrift.Generated.Tag must not be nil")
        _ ->
          [<<11, 1::16-signed, byte_size(key)::32-signed>> | key]
      end, case(v_type) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :v_type on Jaeger.Thrift.Generated.Tag must not be nil")
        _ ->
        ...
        nil ->
          <<>>
        _ ->
          [<<4, 4::16-signed>> | case(v_double) do
            :inf ->
              <<0::1, 2047::11, 0::52>>
            :"-inf" ->
              <<1::1, 2047::11, 0::52>>
        ...
        true ->
          <<2, 5::16-signed, 1>>
        _ ->
          raise(Thrift.InvalidValueError, "Optional boolean field :v_bool on Jaeger.Thrift.Generated.Tag must be true, false, or nil")
      end, case(v_long) do
        nil ->
          <<>>
        _ ->
