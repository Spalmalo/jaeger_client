defmodule(Jaeger.Thrift.Generated.Batch) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(serialize(%Jaeger.Thrift.Generated.Batch{process: process, spans: spans, seq_no: seq_no, stats: stats})) do
      [case(process) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :process on Jaeger.Thrift.Generated.Batch must not be nil")
        _ ->
          [<<12, 1::16-signed>> | Jaeger.Thrift.Generated.Process.serialize(process)]
      end, case(spans) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :spans on Jaeger.Thrift.Generated.Batch must not be nil")
        _ ->
