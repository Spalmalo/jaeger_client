defmodule(Jaeger.Thrift.Generated.OperationSamplingStrategy) do
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.OperationSamplingStrategy{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Jaeger.Thrift.Generated.OperationSamplingStrategy{operation: operation, probabilistic_sampling: probabilistic_sampling})) do
      [case(operation) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :operation on Jaeger.Thrift.Generated.OperationSamplingStrategy must not be nil")
        _ ->
          [<<11, 1::16-signed, byte_size(operation)::32-signed>> | operation]
      end, case(probabilistic_sampling) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :probabilistic_sampling on Jaeger.Thrift.Generated.OperationSamplingStrategy must not be nil")
        _ ->
