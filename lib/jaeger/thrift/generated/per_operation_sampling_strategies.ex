defmodule(Jaeger.Thrift.Generated.PerOperationSamplingStrategies) do
  ...
  defstruct(
    default_sampling_probability: nil,
    default_lower_bound_traces_per_second: nil,
    per_operation_strategies: nil,
    default_upper_bound_traces_per_second: nil
  )
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(
      deserialize(
        <<0, rest::binary>>,
        %Jaeger.Thrift.Generated.PerOperationSamplingStrategies{} = acc
      )
    ) do
      {acc, rest}
    end
    ...
    defp(deserialize(<<4, 1::16-signed, sign::1, 2047::11, frac::52, rest::binary>>, acc)) do
      deserialize(rest, %{
        acc
        | default_sampling_probability: %Thrift.NaN{sign: sign, fraction: frac}
      })
    end
    ...
    defp(deserialize(<<4, 2::16-signed, sign::1, 2047::11, frac::52, rest::binary>>, acc)) do
      deserialize(rest, %{
        acc
        | default_lower_bound_traces_per_second: %Thrift.NaN{sign: sign, fraction: frac}
      })
    end
    ...
    defp(deserialize(<<4, 4::16-signed, sign::1, 2047::11, frac::52, rest::binary>>, acc)) do
      deserialize(rest, %{
        acc
        | default_upper_bound_traces_per_second: %Thrift.NaN{sign: sign, fraction: frac}
      })
    end
    ...
    defp(deserialize__per_operation_strategies(<<rest::binary>>, [list, remaining | stack])) do
      case(
        Elixir.Jaeger.Thrift.Generated.OperationSamplingStrategy.BinaryProtocol.deserialize(rest)
      ) do
        {element, rest} ->
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.PerOperationSamplingStrategies{
        ...
        per_operation_strategies: per_operation_strategies,
        default_upper_bound_traces_per_second: default_upper_bound_traces_per_second
      })
    ) do
      [
        case(default_sampling_probability) do
          nil ->
            raise(
              ...
              "Required field :default_sampling_probability on Jaeger.Thrift.Generated.PerOperationSamplingStrategies must not be nil"
            )
        ...
        case(default_lower_bound_traces_per_second) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :default_lower_bound_traces_per_second on Jaeger.Thrift.Generated.PerOperationSamplingStrategies must not be nil"
            )
        ...
        case(per_operation_strategies) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :per_operation_strategies on Jaeger.Thrift.Generated.PerOperationSamplingStrategies must not be nil"
            )

          _ ->
            [
              <<15, 3::16-signed, 12, length(per_operation_strategies)::32-signed>>
              | for(e <- per_operation_strategies) do
                  Jaeger.Thrift.Generated.OperationSamplingStrategy.serialize(e)
                end
            ]
        end,
        case(default_upper_bound_traces_per_second) do
          nil ->
            <<>>
