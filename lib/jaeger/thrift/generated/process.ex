defmodule(Jaeger.Thrift.Generated.Process) do
  @moduledoc false
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Jaeger.Thrift.Generated.Process{})
    end

    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.Process{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Jaeger.Thrift.Generated.Process{service_name: service_name, tags: tags})) do
      [
        case(service_name) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :service_name on Jaeger.Thrift.Generated.Process must not be nil"
            )
        ...
        case(tags) do
          ...
          _ ->
            [
              <<15, 2::16-signed, 12, length(tags)::32-signed>>
              | for(e <- tags) do
