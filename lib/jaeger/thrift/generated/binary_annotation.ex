defmodule(Jaeger.Thrift.Generated.BinaryAnnotation) do
  @moduledoc false
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Jaeger.Thrift.Generated.BinaryAnnotation{})
    end

    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.BinaryAnnotation{} = acc)) do
      {acc, rest}
    end
    ...
    defp(deserialize(<<12, 4::16-signed, rest::binary>>, acc)) do
      case(Elixir.Jaeger.Thrift.Generated.Endpoint.BinaryProtocol.deserialize(rest)) do
        {value, rest} ->
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.BinaryAnnotation{
        key: key,
        value: value,
      ...
      [
        ...
        case(host) do
          ...
          _ ->
            [<<12, 4::16-signed>> | Jaeger.Thrift.Generated.Endpoint.serialize(host)]
        end
        | <<0>>
      ]
    end
