defmodule(Jaeger.Thrift.Generated.Log) do
  @moduledoc(false)
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Jaeger.Thrift.Generated.Log{})
    end
    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.Log{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Jaeger.Thrift.Generated.Log{timestamp: timestamp, fields: fields})) do
      [case(timestamp) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :timestamp on Jaeger.Thrift.Generated.Log must not be nil")
        _ ->
          <<10, 1::16-signed, timestamp::64-signed>>
      end, case(fields) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :fields on Jaeger.Thrift.Generated.Log must not be nil")
        _ ->
