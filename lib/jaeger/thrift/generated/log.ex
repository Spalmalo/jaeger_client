      ...
      [
        case(timestamp) do
          nil ->
            raise(
              ...
              "Required field :timestamp on Jaeger.Thrift.Generated.Log must not be nil"
            )
        ...
        case(fields) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :fields on Jaeger.Thrift.Generated.Log must not be nil"
            )

          _ ->
            [
              <<15, 2::16-signed, 12, length(fields)::32-signed>>
              | for(e <- fields) do
