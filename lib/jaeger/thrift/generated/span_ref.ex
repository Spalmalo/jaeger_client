defmodule(Jaeger.Thrift.Generated.SpanRef) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.SpanRef{
        ref_type: ref_type,
      ...
      [
        case(ref_type) do
          nil ->
            raise(
              ...
              "Required field :ref_type on Jaeger.Thrift.Generated.SpanRef must not be nil"
            )
        ...
        case(trace_id_low) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :trace_id_low on Jaeger.Thrift.Generated.SpanRef must not be nil"
            )
        ...
        case(trace_id_high) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :trace_id_high on Jaeger.Thrift.Generated.SpanRef must not be nil"
            )
        ...
        case(span_id) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :span_id on Jaeger.Thrift.Generated.SpanRef must not be nil"
            )
