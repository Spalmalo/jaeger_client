defmodule(Jaeger.Thrift.Generated.SpanRef) do
  @moduledoc(false)
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Jaeger.Thrift.Generated.SpanRef{})
    end
    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.SpanRef{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Jaeger.Thrift.Generated.SpanRef{ref_type: ref_type, trace_id_low: trace_id_low, trace_id_high: trace_id_high, span_id: span_id})) do
      [case(ref_type) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :ref_type on Jaeger.Thrift.Generated.SpanRef must not be nil")
        _ ->
          <<8, 1::16-signed, ref_type::32-signed>>
      end, case(trace_id_low) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :trace_id_low on Jaeger.Thrift.Generated.SpanRef must not be nil")
        _ ->
          <<10, 2::16-signed, trace_id_low::64-signed>>
      end, case(trace_id_high) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :trace_id_high on Jaeger.Thrift.Generated.SpanRef must not be nil")
        _ ->
          <<10, 3::16-signed, trace_id_high::64-signed>>
      end, case(span_id) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :span_id on Jaeger.Thrift.Generated.SpanRef must not be nil")
        _ ->
