defmodule(Jaeger.Thrift.Generated.ProbabilisticSamplingStrategy) do
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.ProbabilisticSamplingStrategy{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Jaeger.Thrift.Generated.ProbabilisticSamplingStrategy{sampling_rate: sampling_rate})) do
      [case(sampling_rate) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :sampling_rate on Jaeger.Thrift.Generated.ProbabilisticSamplingStrategy must not be nil")
        _ ->
          [<<4, 1::16-signed>> | case(sampling_rate) do
            :inf ->
              <<0::1, 2047::11, 0::52>>
            :"-inf" ->
              <<1::1, 2047::11, 0::52>>
