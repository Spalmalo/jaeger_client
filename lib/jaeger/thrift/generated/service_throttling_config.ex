defmodule(Jaeger.Thrift.Generated.ServiceThrottlingConfig) do
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(
      deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.ServiceThrottlingConfig{} = acc)
    ) do
      {acc, rest}
    end
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.ServiceThrottlingConfig{
      ...
      [
        case(service_name) do
          nil ->
            raise(
              ...
              "Required field :service_name on Jaeger.Thrift.Generated.ServiceThrottlingConfig must not be nil"
            )
        ...
        case(config) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :config on Jaeger.Thrift.Generated.ServiceThrottlingConfig must not be nil"
            )
