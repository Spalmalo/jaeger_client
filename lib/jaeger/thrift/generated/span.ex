defmodule(Jaeger.Thrift.Generated.Span) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.Span{
      ...
      [
        case(trace_id_low) do
          nil ->
            raise(
              ...
              "Required field :trace_id_low on Jaeger.Thrift.Generated.Span must not be nil"
            )

          _ ->
            <<10, 1::16-signed, trace_id_low::64-signed>>
        end,
        case(trace_id_high) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :trace_id_high on Jaeger.Thrift.Generated.Span must not be nil"
            )
        ...
        case(span_id) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :span_id on Jaeger.Thrift.Generated.Span must not be nil"
            )
        ...
        case(parent_span_id) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :parent_span_id on Jaeger.Thrift.Generated.Span must not be nil"
            )
        ...
        case(operation_name) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :operation_name on Jaeger.Thrift.Generated.Span must not be nil"
            )
        ...
        case(references) do
          ...
          _ ->
            [
              <<15, 6::16-signed, 12, length(references)::32-signed>>
              | for(e <- references) do
        ...
        case(flags) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :flags on Jaeger.Thrift.Generated.Span must not be nil"
            )
        ...
        case(start_time) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :start_time on Jaeger.Thrift.Generated.Span must not be nil"
            )
        ...
        case(duration) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :duration on Jaeger.Thrift.Generated.Span must not be nil"
            )
        ...
        case(tags) do
          ...
          _ ->
            [
              <<15, 10::16-signed, 12, length(tags)::32-signed>>
              | for(e <- tags) do
        ...
        case(logs) do
          ...
          _ ->
            [
              <<15, 11::16-signed, 12, length(logs)::32-signed>>
              | for(e <- logs) do
