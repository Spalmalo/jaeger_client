defmodule(Jaeger.Thrift.Generated.Span) do
  @moduledoc(false)
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Jaeger.Thrift.Generated.Span{})
    end
    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.Span{} = acc)) do
      {acc, rest}
    end
    ...
    defp(deserialize__logs(<<rest::binary>>, [list, remaining | stack])) do
      case(Elixir.Jaeger.Thrift.Generated.Log.BinaryProtocol.deserialize(rest)) do
        {element, rest} ->
    ...
    defp(deserialize__references(<<rest::binary>>, [list, remaining | stack])) do
      case(Elixir.Jaeger.Thrift.Generated.SpanRef.BinaryProtocol.deserialize(rest)) do
        {element, rest} ->
    ...
    defp(deserialize__tags(<<rest::binary>>, [list, remaining | stack])) do
      case(Elixir.Jaeger.Thrift.Generated.Tag.BinaryProtocol.deserialize(rest)) do
        {element, rest} ->
    ...
    def(serialize(%Jaeger.Thrift.Generated.Span{trace_id_low: trace_id_low, trace_id_high: trace_id_high, span_id: span_id, parent_span_id: parent_span_id, operation_name: operation_name, references: references, flags: flags, start_time: start_time, duration: duration, tags: tags, logs: logs})) do
      [case(trace_id_low) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :trace_id_low on Jaeger.Thrift.Generated.Span must not be nil")
        _ ->
          <<10, 1::16-signed, trace_id_low::64-signed>>
      end, case(trace_id_high) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :trace_id_high on Jaeger.Thrift.Generated.Span must not be nil")
        _ ->
          <<10, 2::16-signed, trace_id_high::64-signed>>
      end, case(span_id) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :span_id on Jaeger.Thrift.Generated.Span must not be nil")
        _ ->
          <<10, 3::16-signed, span_id::64-signed>>
      end, case(parent_span_id) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :parent_span_id on Jaeger.Thrift.Generated.Span must not be nil")
        _ ->
          <<10, 4::16-signed, parent_span_id::64-signed>>
      end, case(operation_name) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :operation_name on Jaeger.Thrift.Generated.Span must not be nil")
        _ ->
        ...
        _ ->
          [<<15, 6::16-signed, 12, length(references)::32-signed>> | for(e <- references) do
            Jaeger.Thrift.Generated.SpanRef.serialize(e)
          end]
      end, case(flags) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :flags on Jaeger.Thrift.Generated.Span must not be nil")
        _ ->
          <<8, 7::16-signed, flags::32-signed>>
      end, case(start_time) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :start_time on Jaeger.Thrift.Generated.Span must not be nil")
        _ ->
          <<10, 8::16-signed, start_time::64-signed>>
      end, case(duration) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :duration on Jaeger.Thrift.Generated.Span must not be nil")
        _ ->
        ...
        _ ->
          [<<15, 10::16-signed, 12, length(tags)::32-signed>> | for(e <- tags) do
            Jaeger.Thrift.Generated.Tag.serialize(e)
          end]
      end, case(logs) do
        nil ->
          <<>>
        _ ->
          [<<15, 11::16-signed, 12, length(logs)::32-signed>> | for(e <- logs) do
            Jaeger.Thrift.Generated.Log.serialize(e)
          end]
      end | <<0>>]
    end
  end
