defmodule(Jaeger.Thrift.Generated.Span) do
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(deserialize__annotations(<<rest::binary>>, [list, remaining | stack])) do
      case(Elixir.Jaeger.Thrift.Generated.Annotation.BinaryProtocol.deserialize(rest)) do
        {element, rest} ->
    ...
    defp(deserialize__binary_annotations(<<rest::binary>>, [list, remaining | stack])) do
      case(Elixir.Jaeger.Thrift.Generated.BinaryAnnotation.BinaryProtocol.deserialize(rest)) do
        {element, rest} ->
    ...
    def(
      ...
      [
        ...
        case(annotations) do
          ...
          _ ->
            [
              <<15, 6::16-signed, 12, length(annotations)::32-signed>>
              | for(e <- annotations) do
                  Jaeger.Thrift.Generated.Annotation.serialize(e)
                end
            ]
        end,
        case(binary_annotations) do
          nil ->
            <<>>

          _ ->
            [
              <<15, 8::16-signed, 12, length(binary_annotations)::32-signed>>
              | for(e <- binary_annotations) do
                  Jaeger.Thrift.Generated.BinaryAnnotation.serialize(e)
                end
            ]
        end,
        case(debug) do
          ...
          _ ->
            raise(
              ...
              "Optional boolean field :debug on Jaeger.Thrift.Generated.Span must be true, false, or nil"
            )
        end,
        case(timestamp) do
          nil ->
