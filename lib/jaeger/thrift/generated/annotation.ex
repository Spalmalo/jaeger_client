defmodule(Jaeger.Thrift.Generated.Annotation) do
  @moduledoc false
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Jaeger.Thrift.Generated.Annotation{})
    end

    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.Annotation{} = acc)) do
      {acc, rest}
    end
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.Annotation{
        timestamp: timestamp,
        value: value,
        host: host
      })
      ...
      [
        ...
        case(host) do
          ...
          _ ->
            [<<12, 3::16-signed>> | Jaeger.Thrift.Generated.Endpoint.serialize(host)]
        end
        | <<0>>
      ]
    end
