defmodule(Jaeger.Thrift.Generated.Endpoint) do
  @moduledoc false
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Jaeger.Thrift.Generated.Endpoint{})
    end

    defp(deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.Endpoint{} = acc)) do
      {acc, rest}
    end
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.Endpoint{
        ipv4: ipv4,
        port: port,
