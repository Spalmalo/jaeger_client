defmodule(Jaeger.Thrift.Generated.Collector) do
  ...
  defmodule(SubmitBatchesResponse) do
    ...
    defmodule(BinaryProtocol) do
      ...
      defp(deserialize__success(<<rest::binary>>, [list, remaining | stack])) do
        case(Elixir.Jaeger.Thrift.Generated.BatchSubmitResponse.BinaryProtocol.deserialize(rest)) do
          {element, rest} ->
  ...
  defmodule(Binary.Framed.Server) do
    ...
    def(handle_thrift("submitBatches", binary_data, handler_module)) do
      case(Elixir.Jaeger.Thrift.Generated.Collector.SubmitBatchesArgs.BinaryProtocol.deserialize(binary_data)) do
        {%Jaeger.Thrift.Generated.Collector.SubmitBatchesArgs{batches: batches}, ""} ->
          try do
            ...
            (
              ...
              {:reply, Elixir.Jaeger.Thrift.Generated.Collector.SubmitBatchesResponse.BinaryProtocol.serialize(response)}
            )
          catch
            kind, reason ->
