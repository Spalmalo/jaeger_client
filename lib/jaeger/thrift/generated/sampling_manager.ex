defmodule(Jaeger.Thrift.Generated.SamplingManager) do
  ...
  defmodule(GetSamplingStrategyResponse) do
    ...
    defmodule(BinaryProtocol) do
      ...
      defp(deserialize(<<12, 0::16-signed, rest::binary>>, acc)) do
        case(Elixir.Jaeger.Thrift.Generated.SamplingStrategyResponse.BinaryProtocol.deserialize(rest)) do
          {value, rest} ->
      ...
      def(serialize(%GetSamplingStrategyResponse{success: success})) do
        [case(success) do
          nil ->
            <<>>
          _ ->
            [<<12, 0::16-signed>> | Jaeger.Thrift.Generated.SamplingStrategyResponse.serialize(success)]
        end | <<0>>]
      end
    end
    def(serialize(struct)) do
  ...
  defmodule(Binary.Framed.Client) do
    ...
    def(unquote(:get_sampling_strategy)(client, service_name, rpc_opts \\ [])) do
      ...
      ClientImpl.call(client, "getSamplingStrategy", serialized_args, GetSamplingStrategyResponse.BinaryProtocol, rpc_opts)
    end
    def(unquote(:get_sampling_strategy!)(client, service_name, rpc_opts \\ [])) do
  ...
  defmodule(Binary.Framed.Server) do
    ...
    def(handle_thrift("getSamplingStrategy", binary_data, handler_module)) do
      case(Elixir.Jaeger.Thrift.Generated.SamplingManager.GetSamplingStrategyArgs.BinaryProtocol.deserialize(binary_data)) do
        {%Jaeger.Thrift.Generated.SamplingManager.GetSamplingStrategyArgs{service_name: service_name}, ""} ->
          try do
            rsp = handler_module.get_sampling_strategy(service_name)
            (
              response = %Jaeger.Thrift.Generated.SamplingManager.GetSamplingStrategyResponse{success: rsp}
              {:reply, Elixir.Jaeger.Thrift.Generated.SamplingManager.GetSamplingStrategyResponse.BinaryProtocol.serialize(response)}
            )
          catch
            kind, reason ->
