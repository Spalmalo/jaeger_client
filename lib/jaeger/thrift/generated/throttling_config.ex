defmodule(Jaeger.Thrift.Generated.ThrottlingConfig) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.ThrottlingConfig{
      ...
      [
        case(max_operations) do
          nil ->
            raise(
              ...
              "Required field :max_operations on Jaeger.Thrift.Generated.ThrottlingConfig must not be nil"
            )

          _ ->
            <<8, 1::16-signed, max_operations::32-signed>>
        end,
        case(credits_per_second) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :credits_per_second on Jaeger.Thrift.Generated.ThrottlingConfig must not be nil"
            )
        ...
        case(max_balance) do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :max_balance on Jaeger.Thrift.Generated.ThrottlingConfig must not be nil"
            )
