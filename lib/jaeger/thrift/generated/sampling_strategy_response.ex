defmodule(Jaeger.Thrift.Generated.SamplingStrategyResponse) do
  ...
  defstruct(
    strategy_type: nil,
    probabilistic_sampling: nil,
    rate_limiting_sampling: nil,
    operation_sampling: nil
  )
  ...
  defmodule(BinaryProtocol) do
    ...
    defp(
      deserialize(<<0, rest::binary>>, %Jaeger.Thrift.Generated.SamplingStrategyResponse{} = acc)
    ) do
      {acc, rest}
    end
    ...
    defp(deserialize(<<12, 3::16-signed, rest::binary>>, acc)) do
      case(
        Elixir.Jaeger.Thrift.Generated.RateLimitingSamplingStrategy.BinaryProtocol.deserialize(
          rest
        )
      ) do
        {value, rest} ->
    ...
    defp(deserialize(<<12, 4::16-signed, rest::binary>>, acc)) do
      case(
        Elixir.Jaeger.Thrift.Generated.PerOperationSamplingStrategies.BinaryProtocol.deserialize(
          rest
        )
      ) do
        {value, rest} ->
    ...
    def(
      serialize(%Jaeger.Thrift.Generated.SamplingStrategyResponse{
        strategy_type: strategy_type,
        probabilistic_sampling: probabilistic_sampling,
        rate_limiting_sampling: rate_limiting_sampling,
      ...
      [
        case(strategy_type) do
          nil ->
            raise(
              ...
              "Required field :strategy_type on Jaeger.Thrift.Generated.SamplingStrategyResponse must not be nil"
            )
        ...
        case(rate_limiting_sampling) do
          nil ->
            <<>>
          ...
          _ ->
            [
              <<12, 3::16-signed>>
              | Jaeger.Thrift.Generated.RateLimitingSamplingStrategy.serialize(
                  rate_limiting_sampling
                )
            ]
        end,
        case(operation_sampling) do
          nil ->
            <<>>
          ...
          _ ->
            [
              <<12, 4::16-signed>>
              | Jaeger.Thrift.Generated.PerOperationSamplingStrategies.serialize(
                  operation_sampling
                )
            ]
        end
